...
## Practice 2: *windshield* vs. *windscreen*
...
## Practice 3: Words of certain word-class/part-of-speech containing certain affixes
...
-   Results:
    ...
    -   For more insightful analysese, we need to further process these datasets in Excel or in statistical programming language such as R.
